...
function StakeInfoContent(props) {
    ...
    const [minimum, setMinimum] = useState(currentStake.minimum);
    const [maximum, setMaximum] = useState(currentStake.maximum);
                ...
                {/* Chart */}
                    <Grid item xs={6}>
                        ...
                        >
                            ...
                            <FormControl fullWidth sx={{ m: 1 }} variant="standard">
                                <InputLabel htmlFor="minimum">Minimum Amount Limit</InputLabel>
                                <Input
                                    id="minimum"
                                    value={minimum}
                            ...
                            <FormControl fullWidth sx={{ m: 1 }} variant="standard">
                                <InputLabel htmlFor="maximum">Maximum Amount Limit</InputLabel>
                                <Input
                                    id="maximum"
                                    value={maximum}
