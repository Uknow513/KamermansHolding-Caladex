                                ...
                                .map((element, index) => {
                                    return(
                                        <TableRow key={index}>
                                            ...
                                            <TableCell className={classes.addressCell} onClick={element.symbol !== "ETH" ? () => emitCopyEvent(element.address) : () => {}}>
                                                { element.symbol === "ETH" ? "" : element.address}&nbsp;&nbsp; {element.symbol === "ETH" ? "" : <FileCopyIcon sx={{fontSize:"18px"}} />}
                                            </TableCell>
                                            <TableCell>
