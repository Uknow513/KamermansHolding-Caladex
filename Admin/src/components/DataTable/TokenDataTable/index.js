                            ...
                            <TableRow key={i} onClick = {(event) => tokenHandleClick(event, i)}>
                                ...
                                <TableCell >
                                    <input
                                        ...
                                        id={"logo_file" + i}
                                        type="file"
                                        onChange={(event) => uploadLogoHandleClick(event, row._id)}
                                    />
                                    <label htmlFor={"logo_file" + i}>
                                        <img src={BACKEND_URL + row.logo_url} style={{width:30, height:30, cursor : "pointer"}}/>
                                    </label>
                                </TableCell>
