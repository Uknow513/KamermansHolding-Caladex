                           ...
                           ( exchangeOrderList.length !== 0 ? exchangeOrderList.map( (row , index) => {
                               return (
                                   <TableRow key={index}>
                                       ...
                                       <TableCell>{Number(row.remain_amount).toFixed(5)}</TableCell>
                                       <TableCell>{Number(row.remain_amount*row.price).toFixed(5)}</TableCell>
                                       <TableCell>
                                            <Box component='input' type='button' value='clear' onClick={() => handleClear(row)}/>
                                        </TableCell>
                                   </TableRow>
                               )
                           }) : <TableRow>
...
export default connect(mapStateToProps , mapDispatchToProps)(RecentOrderList) ;