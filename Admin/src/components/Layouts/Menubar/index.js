  ...
  return (
    <div >
      ...
      <Drawer variant="permanent" open={open}>
        ...
        >
          <Grid sx={{ width: '50%' }}>
            <IconButton onClick={() => {history('/dashboard')}}>
              <img src="kamhol.webp" style={{width:40, height:30, cursor : "pointer"}}/>
            </IconButton>
          </Grid>
        ...
        <List >
          ...
          <ListItem button onClick={() => {history('/token')}} selected={CurrentPage=='Tokens'}>
            <ListItemIcon>
              <MonetizationOnTwoToneIcon sx={{color:'white'}}/>
            </ListItemIcon>
          ...
          <ListItem button onClick={() => {history('/order')}} selected={CurrentPage=='Orders'}>
            <ListItemIcon>
              <ReorderIcon sx={{color:'white'}}/>
            </ListItemIcon>
            <ListItemText primary="Orders" />
          </ListItem>
          <ListItem button onClick={() => {history('/trade')}} selected={CurrentPage=='Trades'}>
            <ListItemIcon>
              <FactCheckTwoToneIcon sx={{color:'white'}}/>
            </ListItemIcon>
