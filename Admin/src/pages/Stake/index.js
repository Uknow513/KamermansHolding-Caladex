...
function StakeContent(props) {
  ...
  const uploadAgreementPdfHandleClick = (event) => {
          ...
          <Grid sx={{pl: 5, pr: 5, mt:4, mb:4}}>
            <Box display="flex" justifyContent="flex-end">
                ...
                <input
                    ...
                    id={"file"}
                    type="file"
                    onChange={(event) => uploadAgreementPdfHandleClick(event)}
                />
                <label htmlFor={"file"}>
                    <Button variant="contained" component="span" color='success' style={{height:"100%", marginLeft:10}}>Documentation <UploadIcon /></Button>
                </label>
