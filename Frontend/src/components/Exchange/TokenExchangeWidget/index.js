...
const TokenExchangeWidget = () => {
    ...
    const [amount1 , setDAIAmount1] = useState(50) ;
    const [amount2 , setDAIAmount2] = useState(50) ;
                        ...
                        <div className='card ml-3 mr-1'>
                            <div className='card-body'>
                                <Grid container className={classes.content}>
                                    ...
                                    <Grid item xs={12}>
                                        <input type="range" className="custom-range" min="0" max="100" onChange={(e) => setDAIAmount1(e.target.value)}/>
                                    </Grid>
                                    <Grid item xs={12}>
                                        <Typography className={classes.amountFont}>Trading Amount: <span style={{color : "black", fontWeight: "bold"}}> {amount1} DAI </span></Typography>
                                    </Grid>
                                    <Grid item xs={12}>
                        ...
                        <div className='card ml-1 mr-2'>
                            <div className='card-body'>
                                <Grid container className={classes.content}>
                                    ...
                                    <Grid item xs={12}>
                                        <input type="range" className="custom-range"  min="0" max="100" onChange={(e) => setDAIAmount2(e.target.value)}/>
                                    </Grid>
                                    <Grid item xs={12}>
                                        <Typography className={classes.amountFont}>Trading Amount: <span style={{color : "black", fontWeight: "bold"}}> {amount2} DAI </span></Typography>
                                    </Grid>
                                    <Grid item xs={12}>
