...
export const GetExchangeOrderList = (account, start_time , end_time , token_id , pair_token , is_traded = false  ) => async dispatch => {
    try {
        console.log('Get Exchange Order List') ;
...
export const ClearOrder = (_id) => async dispatch => {
    try {
        let res = await axios.post(`${config.PRIVATE_CALADEX_API}order/delete/${_id}` , {
