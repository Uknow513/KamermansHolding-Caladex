...
const MiniCalaDexTradingView = (props) => {
    ...
    const match1 = useMediaQuery('(min-width : 403px)')
    ...
    return (
        <div className={classes.root} >
            <Box component={"div"} className={classes.infoPanel} >
                ...
                <Box component={"div"}>
                    <Grid container className={classes.tradeData}>
                        <Grid item xs={match1 ? 6 : 12} className={classes.currentPrice}>
                            <Box component={"div"} >
                                {series[0].data.length === 0 ? "0" : currentPrice}
                            </Box>
                        </Grid>
                        <Grid item xs={match1 ? 6 : 12} className={classes.currentInfo}>
                            <Box component={"div"} >
                                {percentChange} % ({total})
                            </Box>
                        </Grid>
            ...
            <Box component={"div"} className={classes.graph}>
                {
                    series === "No Available Information." ? <Box component={"div"} className={classes.emptyTradingView} >
